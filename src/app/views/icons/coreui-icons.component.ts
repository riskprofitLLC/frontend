...
import { DocsLinkComponent } from '../../../components'

@Component({
	templateUrl: 'coreui-icons.component.html',
	providers: [IconSetService],
	imports: [CardComponent, CardHeaderComponent, CardBodyComponent, ColComponent, DocsLinkComponent, IconDirective, RowComponent]
})
